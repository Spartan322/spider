"use strict";
(function () {
    let Node = module.require("../Node").Node, ForInStatement = module.require("./ForInStatement").ForInStatement;
    ...
    ForOfStatement.prototype.codegen = function () {
        ...
        let forInLoop = new ForInStatement(this.key, null, {
            "type": "CallExpression",
            "codeGenerated": true,
            "callee": {
                "type": "MemberExpression",
...
//# sourceMappingURL=src/ast/statements/ForOfStatement.map