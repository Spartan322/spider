"use strict";
(function () {
    let Node = module.require("../Node").Node, ForInStatement = module.require("../statements/ForInStatement").ForInStatement, BlockStatement = module.require("../statements/BlockStatement").BlockStatement;
    ...
    ForInExpression.prototype.codegen = function () {
        ...
        let id = {
            "type": "Identifier",
            "name": this.getNextVariableName("forIn"),
            "codeGenerated": true
        };
        let pushStatement = {
        ...
        let forInStatement = new ForInStatement(this.item, this.index, this.array, new BlockStatement([pushStatement]));
        let fnBlock = new BlockStatement([
            {
...
//# sourceMappingURL=src/ast/expressions/ForInExpression.map